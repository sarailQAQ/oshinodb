...
namespace ast {
    ...
    enum SvFunc {
        SV_FUNC_NULL, SV_FUNC_COUNT, SV_FUNC_MAX, SV_FUNC_MIN, SV_FUNC_SUM
    };
...
// Base class for tree nodes
    ...
    struct SelectCol : public TreeNode {
        ...
        SelectCol(SvFunc sv_func_, std::shared_ptr<Col> col_) : sv_func(sv_func_), col(std::move(col_)) {
            alias = "";
        }

        SelectCol(SvFunc sv_func_, std::shared_ptr<Col> col_, std::string alias_) :
                sv_func(sv_func_), col(std::move(col_)), alias(std::move(alias_)) {}
    };

    struct SelectStmt : public TreeNode {
        std::vector<std::shared_ptr<SelectCol>> cols;
...
// Semantic value
    struct SemValue {
        ...
        std::vector<std::shared_ptr<OrderBy>> sv_orderbys_;
        std::shared_ptr<SelectCol> sv_select_col;
        std::vector<std::shared_ptr<SelectCol>> sv_select_cols;
        SvFunc sv_func;
    };
