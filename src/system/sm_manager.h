...
public:
     ...
     * @param txn the transaction
     */
    void rollback_delete(const std::string &tab_name, Rid &rid, const RmRecord &record, Context *context);
     ...
     */
    void
    rollback_create_index(const std::string &tab_name, const std::vector<std::string> &col_names, Context *context);
     ...
     * @param col_name the name of the column on which index is created
     */
    void rollback_drop_index(const std::string &tab_name, const std::vector<std::string> &col_names, Context *context);
};